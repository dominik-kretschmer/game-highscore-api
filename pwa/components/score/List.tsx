...
export const List: FunctionComponent<Props> = ({ scores }) => (
  <div className="p-4">
    <div className="flex justify-between items-center">
      <h1 className="text-3xl mb-2">Score List</h1>
      <Link
        href="/scores/create"
      ...
      <tbody className="text-sm divide-y divide-gray-200">
        {scores &&
          ...
          scores.map(
            (score) =>
              score["@id"] && (
                <tr className="py-2" key={score["@id"]}>
                  <th scope="row">
                    <ReferenceLinks
                      items={{
                        href: getItemPath(score["@id"], "/scores/[id]"),
                        name: score["@id"],
                      }}
                    />
                  </th>
